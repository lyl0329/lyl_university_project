 ...
 <div class="hh" align="center" style="border:2px solid #000">
  <form action="Upload" enctype="multipart/form-data" method="POST" >
    ...
    <table>
      <tr>
        <td>照片名字：</td>
        <td><input class="mm" type="text" name="pictureName" title="照片名字"></td>
      </tr>
      <tr>
        <td>选择相册：</td>
        <td><select name="albumId" class="mm">
      ...
      <tr>
        <td>照片介绍：</td>
        <td><textarea class="mm" class="mm" rows="5" cols="40" name="pictureIntroduce"></textarea></td>
      </tr>
      <tr>
        <td>上传照片：</td>
        <td><input class="mm" class="mm" type="file" name="file1"></td>
      </tr>
      <tr align="right">
